...
export class TicTacToe extends approve {
  constructor(options = {}) {
    ...
    if (!options.requestMessage) options.requestMessage = '{player} te desafiou para uma partida de **jogo da velha**.';
    if (!options.rejectMessage) options.rejectMessage = 'O jogador recusou seu desafio para a partida de **jogo da velha**.';
