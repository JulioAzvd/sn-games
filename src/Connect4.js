...
export class Connect4 extends approve {
  constructor(options = {}) {
    ...
    if (!options.requestMessage) options.requestMessage = '{player} te desafiou para uma partida de **Conecte4**.';
    if (!options.rejectMessage) options.rejectMessage = 'O player recusou seu desafio para a partida de **Conecte4**.';
